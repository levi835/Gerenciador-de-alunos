                ...
                <table id="example" class="display nowrap" style="width:100%" >
                  ...
                  ?>             
                    ...
                    <td><?php echo $cont++; ?></td>
                      <td>
                      <?php
                      $foto_contato = $show->foto_contatos;
                      // Verifica se a variável $foto_user é igual a 'avatar-padrao.png'
                      if ($foto_contato == 'avatar-padrao.png') {
                          // Exibe a imagem do avatar padrão
                          echo '<img src="../img/avatar_p/' . $foto_contato . '" alt="' . $foto_contato . '" title="' . $foto_contato . '" style="width: 40px; border-radius: 100%;">';
                      } else {
                          // Exibe a imagem do usuário
                          echo '<img src="../img/cont/' . $foto_contato . '" alt="' . $foto_contato . '" title="' . $foto_contato . '" style="width: 40px; border-radius: 100%;">';
                      }?>
                     </td>
